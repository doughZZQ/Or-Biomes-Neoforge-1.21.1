...
public class ModCreativeTab {
    ...
    public static final Supplier<CreativeModeTab> EXAMPLE_TAB  = CREATIVE_MODE_TABS.register("or_biomes_tab",() -> CreativeModeTab.builder()
            ...
            .displayItems((pParameters, pOutput) -> {
                ...
                pOutput.accept(ModBlocks.MAPLE_PLANKS_BLOCK.get());
                ...
                pOutput.accept(ModBlocks.FIR_PLANKS_BLOCK.get());
                ...
                pOutput.accept(ModBlocks.PALM_PLANKS_BLOCK.get());
                ...
                pOutput.accept(ModBlocks.BAOBAB_PLANKS_BLOCK.get());
                ...
                pOutput.accept(ModBlocks.BAYOU_PLANKS_BLOCK.get());
                ...
                pOutput.accept(ModBlocks.HUGE_TOXIC_MUSHROOM_BLOCK.get());
                pOutput.accept(ModBlocks.TOXIC_MUSHROOM_STEM_BLOCK.get());
                pOutput.accept(ModBlocks.PRIMAL_OAK_SAPLING_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_LOG_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_LEAVES_WHITE_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_LEAVES_BLUE_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_LEAVES_PURPLE_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_LEAVES_PINK_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_SAPLING_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_PLANKS_BLOCK.get());

                pOutput.accept(ModBlocks.BIRCH_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.JUNGLE_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.MAPLE_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.MANGROVE_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.BAOBAB_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.ACACIA_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.FIR_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.DARK_OAK_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.OAK_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.CHERRY_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.BAMBOO_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.PALM_PAPER_LANTERN_BLOCK.get());
                pOutput.accept(ModBlocks.WISTERIA_PAPER_LANTERN_BLOCK.get());
