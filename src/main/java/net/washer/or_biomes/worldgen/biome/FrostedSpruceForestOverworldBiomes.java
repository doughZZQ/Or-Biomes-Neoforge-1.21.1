 ...
 * @version 1.0.0
 */
public class FrostedSpruceForestOverworldBiomes {
    ...
    private static Biome FrostedSpruceForestOverworldBiomes(
    ...
    {
        return FrostedSpruceForestOverworldBiomes(pHasPercipitation, pTemperature, pDownfall, rgbToColor(121, 192, 224), rgbToColor(121, 192, 224), rgbToColor(82, 191, 120), null, pMobSpawnSettings, pGenerationSettings, pBackgroundMusic);
    }
    ...
    public static Biome frostedSpruceForestBiome(HolderGetter<PlacedFeature> pPlacedFeatures,
                                       HolderGetter<ConfiguredWorldCarver<?>> pWorldCarvers)
    {
        ...
        // 🌳 树木（重点）
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.FROSTED_SPRUCE_PLACED);
        ...
        // 调用构造返回biome
        return FrostedSpruceForestOverworldBiomes(true, -0.6F, 0.05F,
