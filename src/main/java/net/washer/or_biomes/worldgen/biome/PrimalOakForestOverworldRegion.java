 ...
 * @version 1.0.0
 */
public class PrimalOakForestOverworldRegion extends Region {

    public PrimalOakForestOverworldRegion(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        ...
        new ParameterUtils.ParameterPointListBuilder()
                ...
                .build().forEach(point -> builder.add(point, ModBiomeData.PRIMAL_OAK_FOREST_BIOME));
